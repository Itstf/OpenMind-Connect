        ...
        <div className='container'>
          <div className='relative -mx-4 flex items-center justify-between'>
            <div className='w-60 px-4'>
              <Link to='/openMindconnect' className='navbar-logo block py-5'> <img src={logoOpenMind2} alt='' className='header-logo hover:scale-110 duration-200 ease-in-out' /> </Link>
            </div>
          ...
          <div className='-mx-4 flex flex-wrap'>
            <div className='w-full px-4'>
              <div className='mb-12 max-w-[620px] lg:mb-20'>
                ...
                >
                  Uma gama de serviços destinados a melhorar a comunicação, aumentar a visibilidade do cliente, automatizar processos e otimizar o desempenho de empresas para que elas possam crescer e alcançar novos patamares.
                </p>
              </div>
            </div>
          </div>
          <div className='-mx-4 flex flex-wrap'>
            ...
            <div className='w-full px-4 md:w-1/2 lg:w-1/4'>
              <div className='wow fadeInUp group mb-12 bg-white' data-wow-delay='.2s'>
                ...
                <p className='mb-8 text-body-color lg:mb-11'>
                  Um serviço para alavancar seus clientes e dar visibilidade ao seu perfil.
                </p>
              </div>
            </div>
            <div className='w-full px-4 md:w-1/2 lg:w-1/4'>
            ...
            <div className='w-full px-4'>
              <div className='mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20'>
                ...
                <p
                  className='text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed'
                >
                  Aqui estão algumas perguntas que recebemos frequentemente já respondidas para você.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className='mx-4 w-full'>
              <div className='mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20'>
                ...
                <p
                  className='text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed'
                >
                  O essencial para a nossa forma de trabalhar é o nosso foco na construção de relações fortes com os nossos clientes.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='flex flex-wrap'>
              ...
              >
                ...
                <div className='ud-testimonial-content mb-6'>
                  <p className='text-base tracking-wide text-body-color'>
                    “Eles são uma parte vital do nosso negócio à medida que muitas vezes precisamos de seus conhecimentos.
                  </p>
                </div>
            ...
            <div className='w-full px-4 md:w-1/2 lg:w-1/3'>
              ...
              >
                ...
                <div className='ud-testimonial-content mb-6'>
                  <p className='text-base tracking-wide text-body-color'>
                    “A performance do nosso site melhorou em 1000%, realmente está perceptível o bom trabalho da empresa.
                  </p>
                </div>
                <div className='ud-testimonial-info flex items-center'>
                  <div
            ...
            <div className='w-full px-4 md:w-1/2 lg:w-1/3'>
              ...
              >
                ...
                <div className='ud-testimonial-content mb-6'>
                  <p className='text-base tracking-wide text-body-color'>
                    “A qualidade do serviço é, de forma geral, realmente superior.
                    Continuem garantindo este nível de excelência, é um diferencial.
                  </p>
                </div>
                <div className='ud-testimonial-info flex items-center'>
                  <div
            ...
            <div className='w-full px-4 sm:w-1/2 lg:w-1/4'>
              <div className='wow fadeInUp mb-10' data-wow-delay='.25s'>
                ...
                <div className='text-center'>
                  ...
                  <p className='mb-5 text-sm font-medium text-body-color'>
                    Gerente de Mídias Sociais e Publicidade e Propaganda
                  </p>
                  <div className='flex items-center justify-center'>
                    <a
                      href='javascript:void(0)'
