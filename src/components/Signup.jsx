                ...
                <div className='container'>
                    <div className='relative -mx-4 flex items-center justify-between'>
                        <div className='w-60 px-4'>
                            <Link to='/openMindconnect' className='navbar-logo block py-5'> <img src={logoOpenMind2} alt='' className='header-logo' /> </Link>
                        </div>
                    ...
                    <div className='-mx-4 flex flex-wrap items-center'>
                        <div className='w-full px-4'>
                            <div className='text-center'>
                                <h1 className='text-4xl font-semibold text-white'>Página de Registro</h1>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div
                                ...
                                <div className='mb-10 text-center'>
                                    <a href='javascript:void(0)' className='mx-auto inline-block max-w-[160px]'>
                                        <img src={logoOpenMind1} alt='logo' />
                                    </a>
                                </div>
                                <form>
                                    <div className='mb-6'>
                                    ...
                                    <span className='absolute top-1 right-1'>
                                        <svg width='40' height='40' viewBox='0 0 40 40' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                            ...
                                            <circle cx='25.9911' cy='1.99122' r='1.39737' transform='rotate(-90 25.9911 1.99122)'
                                                fill='#10fc02' />
                                            <circle cx='38.288' cy='38.6026' r='1.39737' transform='rotate(-90 38.288 38.6026)' fill='#10fc02' />
                                            <circle cx='38.288' cy='1.99122' r='1.39737' transform='rotate(-90 38.288 1.99122)' fill='#10fc02' />
                                            ...
                                            <circle cx='25.9911' cy='26.3057' r='1.39737' transform='rotate(-90 25.9911 26.3057)'
                                                fill='#10fc02' />
                                            <circle cx='38.288' cy='26.3057' r='1.39737' transform='rotate(-90 38.288 26.3057)' fill='#10fc02' />
                                            ...
                                            <circle cx='25.9911' cy='14.0086' r='1.39737' transform='rotate(-90 25.9911 14.0086)'
                                                fill='#10fc02' />
                                            <circle cx='38.288' cy='14.0086' r='1.39737' transform='rotate(-90 38.288 14.0086)' fill='#10fc02' />
                                        </svg>
                                    </span>
                                    <span className='absolute left-1 bottom-1'>
                                        <svg width='29' height='40' viewBox='0 0 29 40' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                            <circle cx='2.288' cy='25.9912' r='1.39737' transform='rotate(-90 2.288 25.9912)' fill='#10fc02' />
                                            ...
                                            <circle cx='26.7216' cy='25.9911' r='1.39737' transform='rotate(-90 26.7216 25.9911)'
                                                fill='#10fc02' />
                                            <circle cx='2.288' cy='13.6944' r='1.39737' transform='rotate(-90 2.288 13.6944)' fill='#10fc02' />
                                            ...
                                            <circle cx='26.7216' cy='13.6943' r='1.39737' transform='rotate(-90 26.7216 13.6943)'
                                                fill='#10fc02' />
                                            <circle cx='2.288' cy='38.0087' r='1.39737' transform='rotate(-90 2.288 38.0087)' fill='#10fc02' />
                                            <circle cx='2.288' cy='1.39739' r='1.39737' transform='rotate(-90 2.288 1.39739)' fill='#10fc02' />
                        ...
                        <div className='w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12'>
                            <div className='mb-10 w-full'>
                                ...
                                <div className='-mx-3 flex items-center'>
                                    <a href='javascript:void(0)' className='px-3 text-[#dddddd] hover:text-white'>
                            ...
                            <div className='w-full px-4 md:w-1/3'>
                                <div className='my-1 flex justify-center md:justify-end'>
                                    <p className='text-base text-[#f3f4fe]'>
                                        ...
                                        <a href='' rel='nofollow noopner' target='_blank' className='text-primary hover:underline ml-1'>
                                            OpenMind Connect
                                        </a>
                                    </p>
                                </div>
